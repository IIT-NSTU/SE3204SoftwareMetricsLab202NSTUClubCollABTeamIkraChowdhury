...
if(isset($_POST['username'])){
 ...
 //------------------------searching result is shown--------------------------- 
  ...
  <div class="box-container">
    ...
    <a href="adminaddmember.php?addmember=1  &&  user_id=<?php echo  $row['user_id'] ?>" class="text-danger" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fa-solid fa-plus"></i></a>
    </form>
    </div>
    <?php
         }
